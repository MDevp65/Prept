...
export const PLANS = [
    ...
    },
    {
        ...
        featured: true,
        planId: "cplan_3BqHfuuP77lzgJy8Xcgx6URqrtZ",
        slug: "starter",
        features: [
    ...
    },
    {
        ...
        featured: false,
        planId: "cplan_3BqI18yp8DhcIt1kfHPsnyNypfY",
        slug: "pro",
        features: [
...
export const ONBOARDING_NOROLES = [
    {
        value: "WORKSPACE",
        icon: "💼",
        title: "Go to Workspace",
        desc: "Create and mange your workspaces, projects and tasks.",
    },
    {
        value: "INTERVIEW",
        icon: "👨‍💼",
        title: "I want to interview",
        desc: "Share your expertise, or learn from interviewers, and help engineers level up.",
    },
]
...
export const EXPECT_ITEMS = [
    {
        ...
        features: [
            ...
            ["💬", "Persistent Chat", "Message before and after — share notes, resources, follow-ups.",],
        ]
    },
    {
        plan: "STARTER",
        features: [
            ["🎥", "HD Video Call", "45-minute session with screen sharing built in.",],
            ["🤖", "AI Question Generator", "Role-specific questions generated live during the interview.",],
            ["💬", "Persistent Chat", "Message before and after — share notes, resources, follow-ups.",],
            ["📊", "AI Feedback Report", "Post-interview analysis covering technical depth, communication, and more.",],
        ]
    },
    {
        plan: "PRO",
        features: [
            ...
            ["💬", "Persistent Chat", "Message before and after — share notes, resources, follow-ups.",],
            ["📊", "AI Feedback Report", "Post-interview analysis covering technical depth, communication, and more.",],
            ["📹", "Recording & Playback", "A shareable recording link is generated automatically after the call.",],
        ]
    }
];