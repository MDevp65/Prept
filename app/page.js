...
import { GoldTitle, GrayTitle, SectionHeading, SectionLabel } from "@/components/custom/reusables";
...
import { Bot, Folder, Wallet, Warehouse } from "lucide-react";
      ...
      <section className="relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pt-28 sm:pt-32 pb-20 overflow-hidden">
        ...
        <div className="col-span-full lg:col-span-3 flex flex-col items-center justify-center text-center lg:-rotate-2">
          ...
          <h1 className="font-serif relative text-4xl sm:text-5xl lg:text-6xl tracking-tighter max-w-4xl">
            ...
            &
            <br />
            <GrayTitle>Streamline Your</GrayTitle>
            <br />
            <GoldTitle>Project Management</GoldTitle>
          </h1>
          ...
          <p className="relative text-sm sm:text-base md:text-lg text-stone-400 max-w-xl mt-6 leading-relaxed">
            ...
            to land your dream job. Manage your projects, tasks, and goals all in one place with ease.
          </p>

          <div className="relative flex flex-col md:flex-row justify-center gap-2 sm:gap-4 mt-10 sm:w-auto">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-5">
            <BentoCard
              ...
              title={<GrayTitle>My WorkSpaces</GrayTitle>}
              desc="Manage your interview-prep workspace for each company you apply to."
            >
              <div className="mt-5 rounded-xl bg-[#141417] border border-white/10 p-5 flex justify-between items-end">
                <div>
                  <p className="text-xs text-stone-600 mb-1">Your WorkSpaces</p>
                  <p className="font-serif text-2xl leading-none bg-linear-to-br from-amber-300 to-amber-500 bg-clip-text text-transparent">
                    2 projects
                  </p>
                  <p className="text-xs text-stone-600 mt-1">
                    Created At: 28th May,2026
                  </p>
                </div>
          ...
          <div className="col-span-12 md:col-span-7">
            <BentoCard
              icon={<Folder size={20} className="text-amber-400" />}
              title={<GrayTitle>Projects & Tasks</GrayTitle>}
              desc="Organize projects, create tasks for each interview cycle. Your workspace stays clean and focused."
            >
              <div className="flex flex-wrap gap-2 mt-5">
                {AI_TAGS.map((t) => (
                  <Badge key={t.label} variant={t.active ? "gold" : "outline"}>
      ...
      <section className="relative z-10 pb-28 max-w-5xl mx-auto px-6">
        ...
        <div className="mt-5">
          ...
          >
            ...
            <h3 className="font-serif text-2xl tracking-tight mb-4">
              Manage projects for each company you apply to
            </h3>

            <p className="text-sm text-stone-400 leading-relaxed mb-8">
              Create projects for each company and stay organized and focused. Your workspace stays clean and focused.
            </p>

            <ul className="space-y-3">
              {[
                "Create & Manage your WorkSpaces",
                "Invite your friends to your workspace and collaborate",
                "Create project within workspace, add tasks and schedule interviews",
              ].map((p) => (
                <li key={p} className="flex gap-3 text-sm text-stone-400">
                  <span className="mt-0.5 min-w-4 h-4 rounded-full bg-amber-400/10 border border-amber-400/20 flex items-center justify-center text-xs text-amber-400">
                    ✓
