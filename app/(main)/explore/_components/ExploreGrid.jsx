            ...
            <div className="flex flex-col gap-4">
                <div className="relative max-w-sm">
                    ...
                    <Input
                        ...
                        className='pl-9 bg-stone-[#0f0f11] border-white/10 text-stone-100 placeholder:text-stone-600 text-sm'
                    />
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                    {
                        CATEGORIES.map((cat) => {
                            ...
                            return (
                                <button className={`text-xs px-4 py-2 rounded-lg border transition-all duration-200
                                    ${active
                                        ? "border-amber-400/40 bg-amber-400/10 text-amber-400"
                                        : "border-white/10 text-stone-500 hover:border-white/20"
                                    }
                                    `} key={String(cat.value)} onClick={() => setActiveCategory(cat.value)}>
                                    {cat.label}
                                </button>
                            )
                        })
