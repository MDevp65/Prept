...
import { GrayTitle } from '@/components/custom/reusables';
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-4">
                {/* ── Main picker card ── */}
                <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-5 flex flex-col gap-6">
                    {/* Header */}
                    ...
                    <div className="w-full min-w-0 overflow-x-auto pb-3 scroll-smooth scrollbar-hide">
                        <div className="flex gap-1.5 px-5 w-max">
                            {dates.map((date) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`shrink-0 flex flex-col items-center px-3 py-2 rounded-lg border text-xs transition-all duration-200 ${active
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`mt-0.5 text-xs whitespace-nowrap ${active
                                                ? "text-amber-500/80"
                                                : "text-stone-700"
                                                }`}
                                        >
